...
def create_app(config_name: str = None) -> Flask:
    ...
    app.config["SECRET_KEY"] = os.getenv(
        "SECRET_KEY", "randols-dev-secret-key-change-in-production"
    )
        ...
        return jsonify(
            {
                ...
                "endpoints": {
                    ...
                    "schedule": {
                        ...
                        "optimal_times": {
                            "path": "/api/v1/schedule/optimal-times",
                            "method": "GET",
                        },
                    },
                    "analytics": {
                        ...
                        "platform": {
                            "path": "/api/v1/analytics/platform/<platform>",
                            "method": "GET",
                        },
...
class NotificationBroadcaster:
    ...
    def notify_content_published(cls, content: dict, platform: str):
        ...
        cls.broadcast(
            "content_published",
            {"content": content, "platform": platform, "timestamp": datetime.utcnow().isoformat()},
    ...
    def notify_agent_status(cls, agent_name: str, status: dict):
        ...
        cls.broadcast(
            "agent_status", {"agent": agent_name, "status": status}, room="updates_agents"
        )
