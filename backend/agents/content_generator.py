...
class ContentGeneratorAgent:
    ...
    async def _generate_morning_greeting(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'text': text,
            'hashtags': self.cajun_processor.generate_hashtags(['morning', 'breakfast', 'cajun'], 'instagram'),
    ...
    async def _generate_daily_special(self, context: Dict) -> Dict:
        ...
        specials_by_day = {
            'monday': ('Crawfish Étouffée', 'Our Monday special: rich, creamy étouffée made with fresh Louisiana crawfish and our family\'s secret roux recipe. That\'s some kinda good, cher!'),
            'tuesday': ('Blackened Catfish', 'Tuesday means fresh blackened catfish, seasoned just right with our Cajun spice blend. Served with dirty rice and collard greens.'),
            'wednesday': ('Seafood Gumbo', 'It\'s gumbo weather, y\'all! Our Wednesday special features the darkest chocolate roux and the freshest Gulf seafood. Come get you some!'),
            'thursday': ('Shrimp Po-Boy', 'Thursday Po-Boy special! Fresh Gulf shrimp, crispy fried, dressed and messy - just the way it should be. That gumbo sings!'),
            'friday': ('Boiled Crawfish', 'Friday night crawfish boil! Fresh mudbugs, seasoned with our secret blend since 1973. Laissez les bon temps rouler!'),
            'saturday': ('Weekend Seafood Platter', 'Saturday feast! Our legendary seafood platter with fried shrimp, oysters, catfish, and all the fixings. Perfect for sharing with family.'),
            'sunday': ('Sunday Gumbo Special', 'Sunday family tradition: our award-winning gumbo, made fresh this morning. Three generations of love in every bowl.')
        }
        
        special_name, description = specials_by_day.get(day, ('Chef\'s Special', 'Today\'s chef special is something extraordinary. Come see what\'s cooking!'))
        ...
        return {
            ...
            'hashtags': self.cajun_processor.generate_hashtags(['dailyspecial', 'cajunfood', special_name.lower().replace(' ', '')], 'instagram'),
    ...
    async def _generate_evening_event(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'text': text,
            'hashtags': self.cajun_processor.generate_hashtags(['livemusic', 'zydeco', 'dancing'], 'instagram'),
    ...
    async def _generate_crawfish_content(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'text': text,
            'hashtags': self.cajun_processor.generate_hashtags(['crawfish', 'mudbugs', 'cajunboil'], 'instagram'),
    ...
    async def _generate_event_promotion(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'text': text,
            'event_data': event,
            'hashtags': self.cajun_processor.generate_hashtags(['event', 'livemusic', event['name'].lower().replace(' ', '')], 'instagram'),
            'media_type': 'event_graphic',
            'scheduling_priority': 'high',
            'optimal_time': '12:00',
            'created_at': datetime.now().isoformat()
    ...
    async def _generate_mardi_gras_content(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'platforms': ['instagram', 'facebook', 'tiktok'],
            'text': text,
            'hashtags': self.cajun_processor.generate_hashtags(['mardigras', 'carnival', 'celebration'], 'instagram'),
    ...
    async def _generate_storytelling_content(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'platforms': ['facebook', 'instagram'],
            'text': text,
            'hashtags': self.cajun_processor.generate_hashtags(['family', 'tradition', 'heritage'], 'instagram'),
    ...
    async def _generate_generic_content(self, context: Dict) -> Dict:
        ...
        return {
            ...
            'platforms': ['instagram', 'facebook'],
            'text': text,
            'hashtags': self.cajun_processor.generate_hashtags(['cajunfood', 'louisiana'], 'instagram'),
