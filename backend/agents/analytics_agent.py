...
class AnalyticsAgent:
    ...
    async def analyze_performance(self, time_period: str = '7d') -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Analysis completed: {len(analysis['recommendations'])} recommendations")
            return analysis
    ...
    async def _get_performance_data(self, time_period: str) -> Dict[str, Any]:
        ...
        content_types = ['morning_greeting', 'daily_special', 'crawfish_content', 'event_promotion', 'storytelling']
    ...
    async def _analyze_sentiment(self, data: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            'sentiment_grade': 'Excellent' if avg_sentiment >= 0.8 else 'Good' if avg_sentiment >= 0.6 else 'Needs Attention'
        }
            ...
            if data.get('vs_baseline', 0) < -10:
                recommendations.append({
                    ...
                    'actions': [
                        ...
                        f"Increase video content on {platform}" if platform in ['tiktok', 'instagram'] else f"Increase engagement with community on {platform}"
                    ]
                })
    ...
    async def get_engagement_metrics(self, platform: str = 'all', period: str = '7d') -> Dict[str, Any]:
