...
class InstagramAgent(BasePlatformAgent):
    ...
    async def optimize_content(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        optimized["recommended_dimensions"] = self.config.get(
...
class FacebookAgent(BasePlatformAgent):
    ...
    async def get_analytics(self, post_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "reach": 1650,
            "engagement": 220,
            "reactions": {"like": 150, "love": 45, "haha": 10, "wow": 8, "sad": 0, "angry": 0},
            "comments": 25,
            "shares": 12,
            "clicks": 89,
...
class TikTokAgent(BasePlatformAgent):
    ...
    async def optimize_content(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if len(text) > max_length:
            ...
            optimized["text"] = (
                sentences[0][: max_length - 20] if sentences else text[: max_length - 20]
            )
...
class GooglePostsAgent(BasePlatformAgent):
    ...
    async def optimize_content(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        optimized["google_optimizations"] = {
            "call_to_action": {"type": "LEARN_MORE", "url": "https://randols.com"},
            "image_required": True,
            "expires_in_days": 7,
            "language_code": "en-US",
        }
