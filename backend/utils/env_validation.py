...
ENVIRONMENT_VARIABLES = [
    ...
    EnvVar(
        ...
        sensitive=True,
        description="Google My Business API key"
    ),
    ...
    EnvVar(
        ...
        sensitive=True,
        description="Secondary API key (backup)"
    ),
    EnvVar(
        name="ADMIN_API_KEY",
        sensitive=True,
        description="Admin API key for elevated access"
    ),
    EnvVar(
        name="JWT_SECRET",
        sensitive=True,
